...
public class PlatformController : RaycastController {
    ...
    Dictionary<Transform, Controller2D> passengerDictionnaery = new Dictionary<Transform, Controller2D>();
    ...
    void MovePassengers(bool beforeMovePlatform)
    {
        ...
        {
            if(!passengerDictionnaery.ContainsKey(passenger.transform))
            {
                passengerDictionnaery.Add(passenger.transform, passenger.transform.GetComponent<Controller2D>());
            }
            if(passenger.moveBeforePlatform == beforeMovePlatform)
            {
                passengerDictionnaery[passenger.transform].Move(passenger.velocity, passenger.standingOnPlatform);
            }
        }
    }
